...
public class TiledRaycastCollisionDetector<N extends TiledNode> implements RaycastCollisionDetector<Vector2> {
    ...
    public boolean collides(Ray<Vector2> ray) {
        ...
        for (int x = x0; x <= x1; x++) {
            ...
            //if (tile.isBlock) return true; // We've hit a wall
            error += deltay;
